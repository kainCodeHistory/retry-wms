...
return [
    ...
    */
    ...
    'erp' => [
        'headers' => [
            'access_token' => env('ERP_ACCESS_TOKEN', ''),
            'origin' => env('ERP_ORIGIN', ''),
        ],
        'urls' => [
            'sku' => env('ERP_SKU_URL', ''),
            'supplier' => env('ERP_SUPPLIER_URL', '')
        ]
    ],
    ...
    'reserveDays' => [
        'pickedBatches' => env('PICKED_BATCHES_RESERVE_DAYS', 15),
        'transactions' => env('TRANSACTIONS_RESERVE_DAYS', 100)
    ],
