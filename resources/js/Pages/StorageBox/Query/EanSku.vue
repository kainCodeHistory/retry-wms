        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <div class="p-4 bg-white border-b border-gray-200">
            ...
            <div>
              ...
              <div class="mt-2" v-if="checkSku !== null && checkSku !== ''">
                <wx-label for="checkSku" value="檢核料號"></wx-label>
              ...
              <div class="mt-2" v-if="defaultLocations.length > 0">
                <wx-label for="defaultLocations" value="預設儲位"></wx-label>
                <wx-label id="defaultLocations">
                  <span class="text-blue-800 font-bold text-base">{{
    ...
    async getLocations(e) {
      if (e.key.toUpperCase() === "ENTER" && e.target.value.trim().length > 0) {
        try {
          ...
          this.eanSku = "";
          this.defaultLocations = result.data.defaultLocations;
          this.loader = false;
        } catch (error) {
